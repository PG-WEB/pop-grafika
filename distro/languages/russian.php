...
define('STRING_PRICELIST', 'Список');
//define('STRING_GREETINGS', '<h1><center>ПГ ДИСТРО<center></h1>');//
...
define('ADMIN_ABOUT_PAGE', 'О дистро');
...
define('ADMIN_SPECIAL_OFFERS', 'Сегодня доступны');
